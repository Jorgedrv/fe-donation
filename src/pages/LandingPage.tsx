    ...
    return (
        <div className="bg-white text-gray-800">
            ...
            <Hero
                ...
                cta={<Button size="lg" color="primary">Donate Now</Button>}
            ...
            >
                <div className="grid md:grid-cols-3 gap-10">
                    ...
                    >
                        <Button size="sm" variant="outline" color="primary">Donate</Button>
                    </Card>
            ...
            >
                <div className="mt-10">
                    <Button size="lg" color="primary">Start Donating</Button>
                </div>
            </Section>
        </div>
    );
